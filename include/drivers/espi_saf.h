 ...
 * @defgroup espi_interface ESPI SAF Driver APIs
 ...
 */
struct espi_saf_cfg { /* TODO */
	/** SPI flash frequency in MHz */
	uint8_t spi_freq;
};
 ...
 */
__syscall int espi_saf_config(struct device *dev, struct espi_saf_cfg *cfg);

static inline int z_impl_espi_saf_config(struct device *dev,
					 struct espi_saf_cfg *cfg)
{
 ...
 */
__syscall bool espi_saf_get_channel_status(struct device *dev);

static inline bool z_impl_espi_saf_get_channel_status(struct device *dev)
{
	const struct espi_saf_driver_api *api =
		(const struct espi_saf_driver_api *)dev->driver_api;
 ...
 */
static inline int espi_saf_add_callback(struct device *dev,
					struct espi_callback *callback)
{
	const struct espi_saf_driver_api *api =
		(const struct espi_saf_driver_api *)dev->driver_api;
 ...
 *       espi_add_callback().
 */
static inline int espi_saf_remove_callback(struct device *dev,
					   struct espi_callback *callback)
{
	const struct espi_saf_driver_api *api =
		(const struct espi_saf_driver_api *)dev->driver_api;
