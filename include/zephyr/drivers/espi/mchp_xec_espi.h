 ...
 * for events generated by the Microchip XEC mailbox peripheral. See
 * @ref ESPI_PERIPHERAL_VENDOR_START.
 */
#define MCHP_XEC_ESPI_PERIPHERAL_MAILBOX ESPI_PERIPHERAL_VENDOR_START
