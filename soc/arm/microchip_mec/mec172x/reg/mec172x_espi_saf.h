...
#define MCHP_SAF_FL_CFG_MISC_LSLP_EN_POS	16
#define MCHP_SAF_FL_CFG_MISC_DSLP_EN_POS	17
#define MCHP_SAF_FL_CFG_MISC_SLP_SAC_EN_POS	18
#define MCHP_SAF_FL_CFG_MISC_SAC_RLD_ESPI_POS	20
#define MCHP_SAF_FL_CFG_MISC_SAC_RLD_EC0_POS	21
#define MCHP_SAF_FL_CFG_MISC_SAC_RLD_EC1_POS	22
#define MCHP_SAF_FL_CFG_MISC_RPMC_OP1_FRSC_POS	24
#define MCHP_SAF_FL_CFG_MISC_RPMC_NOP1S_CS0_POS	25
#define MCHP_SAF_FL_CFG_MISC_RPMC_NOP1S_CS1_POS	26
...
/* MEC172x has two 64-byte buffers on AHB for use as RPMC buffers by hardware
 * state-machines. The first buffer is for RPMC OP2 responses initiated
 * by the eSPI Host controller. The second buffer is for RPMC OP2 repsonses
 * initiated by EC0 via the SAF EC Portal.
 */
#define MCHP_XEC_SAF_RPMC_OP2_ESPI_BUF_ADDR	0x40072000U
#define MCHP_XEC_SAF_RPMC_OP2_EC0_BUF_ADDR	0x40072080U
