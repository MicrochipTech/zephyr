 ...
 * @retval Return on success or negative error code
 */
int i2c_xec_nl_get_port(const struct device *dev, uint8_t *port);
 ...
 * @retval Return on success or negative error code
 */
int i2c_xec_nl_config(const struct device *dev, uint32_t config, uint8_t port);
#endif
