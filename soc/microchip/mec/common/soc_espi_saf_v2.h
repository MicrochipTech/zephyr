...
#define MCHP_SAF_EXIT_CM_DESCR12                                                                   \
	(MCHP_QMSPI_C_IFM_4X | MCHP_QMSPI_C_TX_ONES | MCHP_QMSPI_C_TX_DMA_DIS |                    \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_NO_CLOSE |                   \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(13) | MCHP_QMSPI_C_XFR_NUNITS(1))

#define MCHP_SAF_EXIT_CM_DESCR13                                                                   \
	(MCHP_QMSPI_C_IFM_4X | MCHP_QMSPI_C_TX_DIS | MCHP_QMSPI_C_TX_DMA_DIS |                     \
	 MCHP_QMSPI_C_RX_EN | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_CLOSE |                       \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(0) | MCHP_QMSPI_C_XFR_NUNITS(9) |      \
	 MCHP_QMSPI_C_DESCR_LAST)

#define MCHP_SAF_EXIT_CM_DUAL_DESCR12                                                              \
	(MCHP_QMSPI_C_IFM_2X | MCHP_QMSPI_C_TX_ONES | MCHP_QMSPI_C_TX_DMA_DIS |                    \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_NO_CLOSE |                   \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(13) | MCHP_QMSPI_C_XFR_NUNITS(1))

#define MCHP_SAF_EXIT_CM_DUAL_DESCR13                                                              \
	(MCHP_QMSPI_C_IFM_2X | MCHP_QMSPI_C_TX_DIS | MCHP_QMSPI_C_TX_DMA_DIS |                     \
	 MCHP_QMSPI_C_RX_EN | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_CLOSE |                       \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(0) | MCHP_QMSPI_C_XFR_NUNITS(5) |      \
	 MCHP_QMSPI_C_DESCR_LAST)
...
#define MCHP_SAF_POLL_DESCR14                                                                      \
	(MCHP_QMSPI_C_IFM_1X | MCHP_QMSPI_C_TX_DATA | MCHP_QMSPI_C_TX_DMA_DIS |                    \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_NO_CLOSE |                   \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(15) | MCHP_QMSPI_C_XFR_NUNITS(1))

#define MCHP_SAF_POLL_DESCR15                                                                      \
	(MCHP_QMSPI_C_IFM_1X | MCHP_QMSPI_C_TX_DIS | MCHP_QMSPI_C_TX_DMA_DIS |                     \
	 MCHP_QMSPI_C_RX_EN | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_CLOSE |                       \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_NEXT_DESCR(0) | MCHP_QMSPI_C_XFR_NUNITS(2) |      \
	 MCHP_QMSPI_C_DESCR_LAST)
...
#define MCHP_SAF_CS_CFG_DESCR_IDX_REG_VAL(e, r, s)                                                 \
	(((uint32_t)(e) & 0xfU) | (((uint32_t)(r) & 0xfU) << 8) | (((uint32_t)(s) & 0xfU) << 12))
...
#define MCHP_W25Q128_CM_RD_D0                                                                      \
	(MCHP_QMSPI_C_IFM_4X | MCHP_QMSPI_C_TX_DATA | MCHP_QMSPI_C_TX_DMA_DIS |                    \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_NO_CLOSE |                   \
...
#define MCHP_W25Q128_CM_RD_D2                                                                      \
	(MCHP_QMSPI_C_IFM_4X | MCHP_QMSPI_C_TX_DIS | MCHP_QMSPI_C_TX_DMA_DIS |                     \
	 MCHP_QMSPI_C_RX_EN | MCHP_QMSPI_C_RX_LDMA_CH0 | MCHP_QMSPI_C_CLOSE |                      \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_XFR_NUNITS(0) | MCHP_QMSPI_C_DESCR_LAST)

/* Continuous Mode: 24-bit address plus mode byte */
#define MCHP_W25Q128_CM_RD_DUAL_D0                                                                 \
	(MCHP_QMSPI_C_IFM_2X | MCHP_QMSPI_C_TX_DATA | MCHP_QMSPI_C_TX_DMA_DIS |                    \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_NO_CLOSE |                   \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_XFR_NUNITS(4))
...
#define MCHP_W25Q128_ENTER_CM_D2                                                                   \
	(MCHP_QMSPI_C_IFM_4X | MCHP_QMSPI_C_TX_DIS | MCHP_QMSPI_C_TX_DMA_DIS |                     \
	 MCHP_QMSPI_C_RX_DIS | MCHP_QMSPI_C_RX_DMA_DIS | MCHP_QMSPI_C_CLOSE |                      \
	 MCHP_QMSPI_C_XFR_UNITS_1 | MCHP_QMSPI_C_XFR_NUNITS(3) | MCHP_QMSPI_C_DESCR_LAST)
...
#define MCHP_CS0_CFG_DESCR_IDX_REG_VAL MCHP_SAF_CS_CFG_DESCR_IDX_REG_VAL(3U, 0U, 2U)

#define MCHP_CS0_CFG_DESCR_IDX_REG_VAL_DUAL MCHP_SAF_CS_CFG_DESCR_IDX_REG_VAL(3U, 0U, 1U)

/* SAF Flash Config CS1 QMSPI descriptor indices */
#define MCHP_CS1_CFG_DESCR_IDX_REG_VAL MCHP_SAF_CS_CFG_DESCR_IDX_REG_VAL(9U, 6U, 8U)

#define MCHP_CS1_CFG_DESCR_IDX_REG_VAL_DUAL MCHP_SAF_CS_CFG_DESCR_IDX_REG_VAL(9U, 6U, 7U)
