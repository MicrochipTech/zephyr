...
int led_test(void)
{
	 ...
	 */
	k_sleep(K_SECONDS(1));
	LOG_INF("Microchip MEC5 EVB BBLED tests");

	/* test LEDs defined in project / board overlay file */
...
int main(void)
{
	LOG_INF("Microchip MEC5 EVB BBLED Sample - led_mec5 prj");
	led_test();
	while(1) {}
	return 0;
}
