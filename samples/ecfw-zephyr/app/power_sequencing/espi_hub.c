...
int wait_for_vwire(enum espi_vwire_signal signal, uint16_t timeout,
...
int wait_for_espi_reset(uint8_t exp_sts, uint16_t timeout)
{
	int loop_cnt = timeout;
...
int wait_for_pin_monitor_vwire(uint32_t port_pin, uint32_t exp_sts, uint16_t timeout,
