...
/* We only allow turning on peripheral slow clock.
 ...
 * TODO: SilOSC and XTAL can only be turned off if they are not used in current config.
 *       We don't recommend implementing SilOSC and XTAL at this time.
 */
