...
/* Hardware implements 16 reading registers for all packages.
 * The smaller chip packages only hook are reduced number of ADC inputs.
 * Get the actual number of channels hooked up to pins from DT.
 */
