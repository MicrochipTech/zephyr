...
/* Hardware supports two target 7-bit addresses configurable addresses and three fixed.
 * I2C general call address 0
 * SMBus Host address 0x08
 * SMBus Device address 0x61
 */
#define XEC_I2C_OA_NUM_TARGETS    2
#define XEC_I2C_NUM_FIXED_TARGETS 3
#define XEC_I2C_MAX_TARGETS       (XEC_I2C_OA_NUM_TARGETS + XEC_I2C_NUM_FIXED_TARGETS)
