...
/* taf_config_cs_descriptors (general descriptors) */
#define XEC_TAFS_CFG_CS_DESCRIPTORS_OFS      0x06CU
#define XEC_TAFS_CFG_GEN_DESCR_POLL2_MSK     GENMASK(15, 12)
#define XEC_TAFS_CFG_GEN_DESCR_POLL1_MSK     GENMASK(11, 8)
#define XEC_TAFS_CFG_GEN_DESCR_EXIT_CONT_MSK GENMASK(3, 0)
...
#define XEC_TAFS_PD_CR_CS1_WAKE_ON_EC_ACTIVE_EN BIT(3)
#define XEC_TAFS_PD_CR_CS0_WAKE_ON_EC_ACTIVE_EN BIT(2)
#define XEC_TAFS_PD_CR_CS1_POWER_DOWN_EN        BIT(1)
#define XEC_TAFS_DP_CR_CS0_POWER_DOWN_EN        BIT(0)
...
#define XEC_TAFS_ECP_CMD_LEN_MSK GENMASK(32, 24)
...
#define XEC_TAF_PROT_RG_START_DFLT  0x07fffU
