...
/* NEW */
#if 0
#define MEC5_ESPI_CTVW_ENTRY2(node_id) \
...
#define MEC5_ESPI_TCVW_ENTRY2(node_id) \
	[MEC5_VW_SIGNAL(node_id)] = {\
		.host_idx = MEC5_VW_HOST_IDX(node_id), \
		.source = MEC5_VW_SOURCE(node_id), \
		.reg_idx = MEC5_VW_HW_REG_IDX(node_id), \
...
const struct espi_mec5_vwire2 espi_mec5_vw2_tbl[] = {
	DT_FOREACH_CHILD_STATUS_OKAY(MEC5_DT_ESPI_CT_VWIRES_NODE, MEC5_ESPI_CTVW_ENTRY2)
	DT_FOREACH_CHILD_STATUS_OKAY(MEC5_DT_ESPI_TC_VWIRES_NODE, MEC5_ESPI_TCVW_ENTRY2)
};
#endif
