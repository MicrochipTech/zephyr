...
#define XEC_KBC_ACTV_OFS 0x330u
#define XEC_KBC_ACTV_EN_POS 0

#define XEC_P92_CR_OFS   0
#define XEC_P92_CR_ALT_CPU_RST_POS 0
#define XEC_P92_CR_ALT_GATE_A20_POS 1

#define XEC_P92_ACTV_OFS 0x330u
#define XEC_P92_ACTV_EN_POS 0
...
#define XEC_EMI_RWL_MR0_WL_POS 0
#define XEC_EMI_RWL_MR0_WL_MSK GENMASK(14, 0)
#define XEC_EMI_RWL_MR0_WL_SET(wlim) FIELD_PREP(XEC_EMI_RWL_MR0_WL_MSK, (wlim))
#define XEC_EMI_RWL_MR0_WL_GET(r) FIELD_GET(XEC_EMI_RWL_MR0_WL_MSK, (r))
#define XEC_EMI_RWL_MR0_RL_POS 16
#define XEC_EMI_RWL_MR0_RL_MSK GENMASK(30, 16)
#define XEC_EMI_RWL_MR0_RL_SET(rlim) FIELD_PREP(XEC_EMI_RWL_MR0_RL_MSK, (rlim))
#define XEC_EMI_RWL_MR0_RL_GET(r) FIELD_GET(XEC_EMI_RWL_MR0_RL_MSK, (r))
