...
#define ESPI_GC_CAP1_MAX_FREQ_20M       FIELD_PREP(ESPI_GC_CAP1_MAX_FREQ_MSK, 0)
#define ESPI_GC_CAP1_MAX_FREQ_25M       FIELD_PREP(ESPI_GC_CAP1_MAX_FREQ_MSK, 1)
#define ESPI_GC_CAP1_MAX_FREQ_33M       FIELD_PREP(ESPI_GC_CAP1_MAX_FREQ_MSK, 2)
#define ESPI_GC_CAP1_MAX_FREQ_50M       FIELD_PREP(ESPI_GC_CAP1_MAX_FREQ_MSK, 3)
#define ESPI_GC_CAP1_MAX_FREQ_66M       FIELD_PREP(ESPI_GC_CAP1_MAX_FREQ_MSK, 4)
#define ESPI_GC_CAP1_ALERT_MODE_PIN_POS 19
#define ESPI_GC_CAP1_IOM_POS            20
#define ESPI_GC_CAP1_IOM_MSK            GENMASK(21, 20)
#define ESPI_GC_CAP1_IOM_S_VAL          0
#define ESPI_GC_CAP1_IOM_SD_VAL         1
#define ESPI_GC_CAP1_IOM_SQ_VAL         2
#define ESPI_GC_CAP1_IOM_SDQ_VAL        3
#define ESPI_GC_CAP1_IOM_S              FIELD_PREP(ESPI_GC_CAP1_IOM_MSK, 0)
#define ESPI_GC_CAP1_IOM_SD             FIELD_PREP(ESPI_GC_CAP1_IOM_MSK, 1)
#define ESPI_GC_CAP1_IOM_SQ             FIELD_PREP(ESPI_GC_CAP1_IOM_MSK, 2)
#define ESPI_GC_CAP1_IOM_SDQ            FIELD_PREP(ESPI_GC_CAP1_IOM_MSK, 3)
...
#define ESPI_GC_PC_MPLS_64B             FIELD_PREP(ESPI_GC_PC_MPLS_MSK, 1)
...
#define ESPI_FC_CR_FUNC_READ     FIELD_PREP(ESPI_FC_CR_FUNC_MSK, 0)
#define ESPI_FC_CR_FUNC_WRITE    FIELD_PREP(ESPI_FC_CR_FUNC_MSK, 1)
#define ESPI_FC_CR_FUNC_ERASE_SM FIELD_PREP(ESPI_FC_CR_FUNC_MSK, 2)
#define ESPI_FC_CR_FUNC_ERASE_LG FIELD_PREP(ESPI_FC_CR_FUNC_MSK, 3)
...
#define ESPI_FC_CFG                 0x29cu /* all RO except where specified */
#define ESPI_FC_CFG_BUSY_POS        0
#define ESPI_FC_CFG_EBSZ_POS        2
#define ESPI_FC_CFG_EBSZ_MSK        GENMASK(4, 2)
#define ESPI_FC_CFG_EBSZ_4K_VAL     1
#define ESPI_FC_CFG_EBSZ_64K_VAL    2
#define ESPI_FC_CFG_EBSZ_4K_64K_VAL 3
#define ESPI_FC_CFG_EBSZ_128K_VAL   4
#define ESPI_FC_CFG_EBSZ_256K_VAL   1
#define ESPI_FC_CFG_EBSZ_4K         FIELD_PREP(ESPI_FC_CFG_EBSZ_MSK, ESPI_FC_CFG_EBSZ_4K_VAL)
#define ESPI_FC_CFG_EBSZ_64K        FIELD_PREP(ESPI_FC_CFG_EBSZ_MSK, ESPI_FC_CFG_EBSZ_64K_VAL)
#define ESPI_FC_CFG_EBSZ_4K_64K     FIELD_PREP(ESPI_FC_CFG_EBSZ_MSK, ESPI_FC_CFG_EBSZ_4K_64K_VAL)
#define ESPI_FC_CFG_EBSZ_128K       FIELD_PREP(ESPI_FC_CFG_EBSZ_MSK, ESPI_FC_CFG_EBSZ_128K_VAL)
#define ESPI_FC_CFG_EBSZ_256K       FIELD_PREP(ESPI_FC_CFG_EBSZ_MSK, ESPI_FC_CFG_EBSZ_256K_VAL)
#define ESPI_FC_CFG_EBSZ_GET(rv)    FIELD_GET(ESPI_FC_CFG_EBSZ_MSK, (rv))
#define ESPI_FC_CFG_MPLD_POS        8
#define ESPI_FC_CFG_MPLD_MSK        GENMASK(10, 8)
#define ESPI_FC_CFG_MPLD_64_VAL     1
#define ESPI_FC_CFG_MPLD_128_VAL    2
#define ESPI_FC_CFG_MPLD_256_VAL    3
#define ESPI_FC_CFG_MPLD_64         FIELD_PREP(ESPI_FC_CFG_MPLD_MSK, ESPI_FC_CFG_MPLD_64_VAL)
#define ESPI_FC_CFG_MPLD_128        FIELD_PREP(ESPI_FC_CFG_MPLD_MSK, ESPI_FC_CFG_MPLD_128_VAL)
#define ESPI_FC_CFG_MPLD_256        FIELD_PREP(ESPI_FC_CFG_MPLD_MSK, ESPI_FC_CFG_MPLD_256_VAL)
#define ESPI_FC_CFG_MPLD_GET(rv)    FIELD_GET(ESPI_FC_CFG_MPLD_MSK, (rv)) /* rv = register value */
#define ESPI_FC_TAF_MODE_POS        11
#define ESPI_FC_CFG_MRDR_POS        12
#define ESPI_FC_CFG_MRDR_MSK        GENMASK(14, 12)
#define ESPI_FC_CFG_MDRD_64_VAL     1
#define ESPI_FC_CFG_MDRD_128_VAL    2
#define ESPI_FC_CFG_MDRD_256_VAL    3
#define ESPI_FC_CFG_MDRD_512_VAL    4
#define ESPI_FC_CFG_MDRD_1K_VAL     5
#define ESPI_FC_CFG_MDRD_2K_VAL     6
#define ESPI_FC_CFG_MDRD_4K_VAL     7
#define ESPI_FC_CFG_MRDR_64         FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_64_VAL)
#define ESPI_FC_CFG_MRDR_128        FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_128_VAL)
#define ESPI_FC_CFG_MRDR_256        FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_256_VAL)
#define ESPI_FC_CFG_MRDR_512        FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_512_VAL)
#define ESPI_FC_CFG_MRDR_1K         FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_1K_VAL)
#define ESPI_FC_CFG_MRDR_2K         FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_2K_VAL)
#define ESPI_FC_CFG_MRDR_4K         FIELD_PREP(ESPI_FC_CFG_MRDR_MSK, ESPI_FC_CFG_MDRD_4K_VAL)
#define ESPI_FC_CFG_MRDR_GET(rv)    FIELD_GET(ESPI_FC_CFG_MRDR_MSK, (rv))
#define ESPI_FC_CFG_CTF_POS         28 /* R/W */
#define ESPI_FC_CFG_CTF_CAF         0
#define ESPI_FC_CFG_CTF_TAF         BIT(ESPI_FC_CFG_CTF_POS)
#define ESPI_FC_CFG_CTF_LOCK_POS    29
...
#define ESPI_MC_MBAR_CFG_HW(id, hw) (ESPI_MC_MBAR_CFG_OFS + ((uint32_t)(id) * 10u) + ((hw) * 2u))
