				    ...
				    enum espi_virtual_peripheral periph)
{
	...
	/* disable and clear GIRQ status */
	xec_ecia_info_girq_ctrl(acpi_ec_cfg->obe_ecia_info, MCHP_XEC_ECIA_GIRQ_DIS);
...
static const struct xec_acpi_ec_config xec_acpi_ec2_cfg = {
	...
	.host_io_addr = DT_PROP_OR(XEC_AEC2_NODE, host_mem, UINT32_MAX),
	.host_mem_addr = DT_PROP_OR(XEC_AEC2_NODE, host_io, UINT16_MAX),
	.obf_sirq_slot_val = MCHP_ESPI_IO_SIRQ_DIS;
}
;
...
#define XEC_AEC2_NODE DT_NODELABEL(acpi_ec3)
...
static const struct xec_acpi_ec_config xec_acpi_ec3_cfg = {
	...
	.host_io_addr = DT_PROP_OR(XEC_AEC3_NODE, host_mem, UINT32_MAX),
	.host_mem_addr = DT_PROP_OR(XEC_AEC3_NODE, host_io, UINT16_MAX),
	.obf_sirq_slot_val = MCHP_ESPI_IO_SIRQ_DIS;
}
;
