...
#. Make the image generation available for Zephyr, by making the tool
   ...
   .. code-block:: console
      ...
      export MEC172X_SPI_GEN=<path to tool>/mec172x_spi_gen_lin64
...
.. _MEC172x Reference Manual:
    https://github.com/MicrochipTech/CPGZephyrDocs/blob/master/MEC172x/MEC172x-Data-Sheet-DS00003583A.pdf
